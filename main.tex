...
% Modified by Wei Zichao (exusiai.wei@outlook.com) to fit the need of BLCU students.

\documentclass[12pt]{BLCUletter}
\usepackage{fontspec} 
\usepackage{tikz} 
\usepackage{xcolor}
\definecolor{blcugreen}{RGB}{28, 89, 152}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\begin{tikzpicture}
    ...
    {\includegraphics[width=0.55\textwidth]{background-blcu.png}};   % blculogo watermark
    \end{tikzpicture}
\vfill}}}
...
\def\name{xxx \\
	Professor \\
	Faculty of Linguistic Sciences, BLCU \\
	Institute of Quantitative Linguisitcs \\
	xxxx@blcu.edu.cn 
}
%
...
\def\Where{\hspace{-1.2mm}\textbf{\color{blcugreen}%{blcugreen}
...
\def\Address{No.15 Xueyuan Road
} 
%
\def\CityZip{Haidian, Beijing 100083 \\
	P.R.China} 
%
% Set your blcu e-mail here
\def\Email{\textbf{\color{blcugreen}E-mail}: wnn@blcu.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{blcugreen}Tel/Fax}: 0086-10-8230 3926}
%
% Set your department or personal website here
\def\URL{\textbf{\color{blcugreen}URL}: {https://english.blcu.edu.cn/}}
%
...
\def\school{\small{
		BLCU $\cdot$
		~Faculty of Linguistic Sciences $\cdot$
		~No.15 Xueyuan Road $\cdot$
		~Beijing, China P.R} } 
